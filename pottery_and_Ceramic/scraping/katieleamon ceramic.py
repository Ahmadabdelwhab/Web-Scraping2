...
result = requests.get(
    f"https://katieleamon.com/c/luxury-ceramics/?_gl=1*16hsfs4*_up*MQ..*_ga*MzU5NjIwNjUwLjE3MTg4Nzg3NTQ.*_ga_X8JTEFMZ6X*MTcxODg3ODc1MS4xLjEuMTcxODg3ODc2Ny4wLjAuMA.."
)
...
with open(
    "C:/Users/Qebaa/OneDrive/Desktop/Web Scraping2/pottery and Ceramic/soy candles2.csv",
    "w",
    newline="",
) as myfile:
